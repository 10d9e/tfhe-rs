...
use self::bootstrapping::keyswitch;
            ...
            Ciphertext::Encrypted(ct_condition_ct) => {
                ...
                match server_key.pbs_order {
                    PBSOrder::KeyswitchBootstrap => {
                        let ct_ks_1 = keyswitch(buffer_lwe_before_pbs, server_key);
                        ...
                        let ct_ks_2 = keyswitch(&ct_temp_2, server_key);
                    ...
                    PBSOrder::BootstrapKeyswitch => {
                        ...
                        let ct_ks = keyswitch(&ct_pbs_1, server_key);
